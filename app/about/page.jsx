...
const page = () => {
  ...
  return (
    <div className=" text-[#2B1B12]">
      ...
      {/* ================= WHY CHOOSE US ================= */}
      <section className="md:py-20 py-8 bg-[#efcdba]">
        <div className="max-w-7xl mx-auto px-6">

          {/* Heading */}
          <div className="max-w-3xl mb-4 md:mb-10">
            ...
            {[
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-base leading-6 text-white group-hover:text-white/90 transition-colors duration-300">
                    {item.desc}
                  </p>
                </div>
              </div>
