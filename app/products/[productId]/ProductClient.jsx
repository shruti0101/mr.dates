      ...
      <section className="bg-[#FDFBF7] my-15 md:mt-5">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-2 gap-10 items-start max-md:grid-cols-1 max-md:px-4 max-md:gap-0">
          ...
          <div className="mt-10 ">
            ...
            {/* Description */}
            <p className=" max-w-xl text-[20px] leading-[1.5] text-black max-md:text-[16px] max-md:leading-[1.6]">
              {product.excerpt}
            </p>
            ...
            <div className="flex items-center gap-3 mt-3">
              ...
              {selectedPack?.weight && (
                <p className="text-md text-red-600 capitalize">
                  ({selectedPack.weight} pack • inclusive of all taxes)
                </p>
              )}
            </div>

            {/* Divider */}
            <div className="mt-3 w-full h-px bg-[#e6e1da]" />
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 ">
                      {product.packaging.map((pack, index) => (
                        ...
                        >
                          <span className=" text-3xl font-serif text-[#6b1f2b] text-center">
                            {pack.weight}
                          </span>
  ...
  {product.price}
            ...
            <div className="mt-3 flex flex-col font-bold">
              ...
              <div className="flex items-center gap-6 mt-3">
                {/* quantity */}
                <div className="flex bg-gray-200 w-fit p-4 rounded-md items-center gap-4">
                ...
                <a
                  href="tel:9456664444"
                  className="bg-black animate-pulse text-white px-8 h-full py-3 rounded-sm text-xl hover:bg-gray-800 transition"
                >
                  Want Bulk Order
                </a>
              </div>
            ...
            <div className="mt-7 bg-[#f6efe5] rounded-2xl p-6 max-w-xl max-md:p-4">
              <div className="flex flex-row gap-4 max-md:flex-col">
                ...
                <a
                  ...
                  className="w-full cursor-pointer bg-black text-white py-3 rounded-xl text-lg tracking-[0.18em] flex items-center justify-center gap-3 hover:bg-[#7a1f2b] transition max-md:text-base"
                >
                  Add To Cart
                ...
                <button
                  ...
                  className="w-full cursor-pointer bg-[#8b2d36] text-white py-3 rounded-xl text-lg tracking-[0.18em] flex items-center justify-center gap-3 transition hover:bg-black max-md:text-base"
                >
                  Add To Wishlist
                  <Heart size={22} />
                </button>
