  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    >
      ...
      <div className="flex flex-col items-center text-center gap-4 relative">
       ...
       <Image alt="count" width={100} height={100} src="/countup/delivery.gif"></Image>
        </div>
      ...
      <div className="flex flex-col items-center text-center gap-4 relative">
       ...
       <Image alt="count" width={100} height={100} src="/countup/pay.gif"></Image>
        </div>
      ...
      <div className="flex flex-col items-center text-center gap-4 relative">
       ...
       <Image alt="count" width={100} height={100} src="/countup/quality.gif"></Image>
        </div>
        <p className="text-lg font-medium">
      ...
      <div className="flex flex-col items-center text-center gap-4">
       ...
       <Image alt="count" width={100} height={100} src="/countup/reward.gif"></Image>
        </div>
        <p className="text-lg font-medium">
