...
const InquiryCategory = ({ setFormOpen }) => {
    ...
    return (
        <section
            ...
            className="relative py-10 overflow-hidden [perspective:1200px] bg-cover bg-center"
        >
  ...
  "
                >
                    {category.map((item, index) => (
                        <div key={index} className="block" onClick={() => setFormOpen(true)}>
                            <motion.div
          ...
          rounded-3xl lg:px-6 lg:pt-14 lg:pb-6 pt-10 py-5 px-2 text-center
