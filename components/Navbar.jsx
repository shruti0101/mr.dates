          ...
          <nav className="hidden md:flex items-center gap-10 font-poppins font-medium">
            ...
            {["Home", "About"].map((item) => (
              <a
                ...
                className={`text-[18px]  uppercase font-bold text-white hover:text-[#F8CC19] transition`}
              >
                {item}
              </a>
            ))}
            ...
            {["Blogs", "Bulk Order", "Contact"].map((item) => (
              <a
                key={item}
                href={`/${item.toLowerCase()}`}
                className={`text-[18px] font-bold uppercase text-white hover:text-[#F8CC19] transition`}
              >
                {item}
              </a>
            ))}
