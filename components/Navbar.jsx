          ...
          <nav className="hidden md:flex items-center gap-10 font-poppins font-medium">
            ...
            {["Home", "About"].map((item) => (
              <a
                ...
                className={`text-[18px] tracking-wider font-bold text-white hover:text-[#F8CC19] transition`}
              >
                {item}
              </a>
            ))}
            ...
            >
              <Link
                href="/products"
                className={`text-[18px] font-bold tracking-wider text-white hover:text-[#F8CC19] transition`}
              >
                Our Products
              </Link>
            ...
            {["Blogs", "Bulk Order", "Contact"].map((item) => (
              <a
                key={item}
                href={`/${item.toLowerCase()}`}
                className={`text-[19px] font-bold tracking-wider text-white hover:text-[#F8CC19] transition`}
              >
                {item}
              </a>
            ))}
