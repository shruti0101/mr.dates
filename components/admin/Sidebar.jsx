...
export default function Sidebar({ setSidebarOpen, sidebarOpen }) {
  ...
  return (
    <aside
      className={`fixed md:static z-40 min-h-screen w-64 bg-white shadow-xl transform transition-transform duration-300 
    ...
    >
      ...
      <nav className="p-5 space-y-3 h-full">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full text-left bg-red-600 text-white px-4 py-2 rounded-lg shadow hover:bg-red-700 transition mt-auto"
        >
          <LogOut size={20} />
          Logout
        </button>
